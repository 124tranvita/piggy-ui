      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute z-10 mt-1 right-0 max-h-60 w-52 overflow-auto rounded-md bg-white dark:bg-slate-900 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                    ...
                    <>
                      <span
                        className={`block truncate ${
                          selected
                            ? 'font-semibold'
                            : 'font-normal dark:text-slate-200'
                        }`}
                      >
                        {el.period}
                      </span>
