  ...
  return (
    <>
      ...
      <Menu as="div" className="relative inline-block text-left">
        ...
        <NavMenuTransition>
          <Menu.Items className="absolute right-0 mt-2 w-64 md:w-80 xl:w-96 origin-top-right rounded-md divide-y divide-gray-100 dark:divide-slate-600 bg-white dark:bg-slate-900 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
  ...
  return (
    <>
      <div
        id="toast-default"
        className={`${
          isToastOpen ? 'block' : 'hidden'
        } duration-300 absolute left-0 right-0 mx-auto top-10 flex items-center p-4 w-full max-w-xs text-gray-500 dark:text-slate-200 bg-white dark:bg-slate-900 rounded-lg shadow-lg`}
        role="alert"
      >
        ...
        <button
          ...
          onClick={() => dispatch({ type: 'SET_ISTOASTOPEN', payload: false })}
        >
